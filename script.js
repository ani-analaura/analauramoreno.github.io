...
(function () {
  ...
  function fitDeck() {
    ...
    var headingSpace = headingEl ? headingEl.getBoundingClientRect().height + 64 : 0; // 64 = its own margin-bottom
    var availH = window.innerHeight - paddingTop - headingSpace - DECK_BOTTOM_BUFFER;
